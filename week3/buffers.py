...
class ReplayBuffer():
    '''
    Replay Buffer class to keep the agent memories memorized in
    a deque structure.
    '''
    ...
    def sample(self, batch_size):
        ...
        for i in indices:
            ...
            # N-step look ahead loop to compute the reward and pick the new
            # 'next_state' (of the n-th state)
            ...
            # Populate the arrays with the next_state,
            # reward and dones just computed
